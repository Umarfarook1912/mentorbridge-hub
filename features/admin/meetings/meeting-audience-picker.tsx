...
interface MeetingAudiencePickerProps {
  ...
  studentIds: string[]
  onDomainsChange: (domains: MeetingDomain[]) => void
  onStudentIdsChange: (ids: string[]) => void
  error?: { message?: string }
}

export function MeetingAudiencePicker({
  domains,
  studentIds,
  onDomainsChange,
  onStudentIdsChange,
  error,
}: MeetingAudiencePickerProps) {
    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="text-muted-foreground text-xs">
          All students, domain groups, and/or specific people. Groups and people combine.
        </p>
      </div>
